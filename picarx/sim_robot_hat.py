...
class Grayscale_Module(object):
    ...
    def read_status(self, fl_list):
        if fl_list[0] > self._reference[0] and fl_list[1] > self._reference[1] and fl_list[2] > self._reference[2]:
            return 'stop'
            
        elif fl_list[1] <= self._reference[1]:
            return 'forward'
        
        elif fl_list[0] <= self._reference[0]:
            return 'right'

        elif fl_list[2] <= self._reference[2]:
            return 'left'
